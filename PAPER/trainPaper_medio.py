...
def run_training():
    ...
    for run in range(1, NUM_RUNS + 1):
        ...
        # num_workers=0 para evitar bloqueos estocásticos de multiprocesamiento en Windows
        ...
        # EL NÚCLEO DE LA MEJORA: Regularización L2 (weight_decay)
        optimizer = optim.Adam(model.parameters(), lr=LR, weight_decay=1e-5)
        
        # EL NÚCLEO DE LA MEJORA: Scheduler para evitar el estallido del gradiente
        ...
        # Guardar modelo
        torch.save(model.state_dict(), f'models/td_3dcnn_paper_medio_{total_clips}_run{run}.pth')
